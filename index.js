...
const uceBolunenlerinToplami = uceTamBolunenler.reduce((sum, sayi) => sum + sayi, 0);

//console.log(uceBolunenlerinToplami);
// 3d çözümü

const besyuzdenKucukSayilar = sayilar.filter((besYüz) => besYüz < 500);
